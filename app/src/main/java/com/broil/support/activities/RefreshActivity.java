...
import com.broil.support.widget.refresh.MaterialRefreshLayout;
import com.broil.support.widget.refresh.MaterialRefreshListener;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        materialRefreshLayout.setMaterialRefreshListener(new MaterialRefreshListener() {
            ...
            public void onFinish() {
                Toast.makeText(RefreshActivity.this, "finish", Toast.LENGTH_LONG).show();
            }
...
//                    break;
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new SimpleStringRecyclerViewAdapter(RefreshActivity.this));
