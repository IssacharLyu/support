...
public class RecyclerViewHeader extends RelativeLayout {
    ...
    /**
     * Attaches <code>com.broil.support.widget.RecyclerViewHeader</code> to <code>RecyclerView</code>.
     * Be sure that <code>setLayoutManager(...)</code> has been called for <code>RecyclerView</code> before calling this method.
     *
     * @param recycler <code>RecyclerView</code> to attach <code>com.broil.support.widget.RecyclerViewHeader</code> to.
     */
    ...
    /**
     * Detaches <code>com.broil.support.widget.RecyclerViewHeader</code> from <code>RecyclerView</code>.
     */
    ...
    private void validate(RecyclerView recyclerView) {
        if (recyclerView.getLayoutManager() == null) {
            throw new IllegalStateException("Be sure to attach com.broil.support.widget.RecyclerViewHeader after setting your RecyclerView's LayoutManager.");
        }
    }
...
//                staggeredGrid = (StaggeredGridLayoutManager) manager;
                ...
                throw new IllegalArgumentException("Currently com.broil.support.widget.RecyclerViewHeader supports only LinearLayoutManager and GridLayoutManager.");
            }
        }
