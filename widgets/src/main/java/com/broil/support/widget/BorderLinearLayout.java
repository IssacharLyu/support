...
public class BorderLinearLayout extends LinearLayout {
	...
	public BorderLinearLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.Border, 0, 0);
		mBorderColor = a.getColor(R.styleable.Border_border_b_color, Color.RED);
		mBoderLeftSize = a.getDimensionPixelSize(R.styleable.Border_border_left_size,DEFAULT_BORDER_SIZE);
		mBoderTopSize = a.getDimensionPixelSize(R.styleable.Border_border_top_size,DEFAULT_BORDER_SIZE);
		mBoderRightSize = a.getDimensionPixelSize(R.styleable.Border_border_right_size,DEFAULT_BORDER_SIZE);
		mBoderBottomSize = a.getDimensionPixelSize(R.styleable.Border_border_bottom_size,DEFAULT_BORDER_SIZE);
		isBorderEnable = a.getBoolean(R.styleable.Border_border_enable, true);
		a.recycle();
		init();
	}
