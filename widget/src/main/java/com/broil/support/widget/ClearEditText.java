...
//    private Drawable mTransDrawable;
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = getResources().getDrawable(R.mipmap.abc_ic_input_clear);
        }
//        mTransDrawable = getResources().getDrawable(R.drawable.ic_transparent);
        // 默认设置隐藏图标
...
//            left = visible ? mTransDrawable : null;
        } else {
            left = getCompoundDrawables()[0];
        }
        setCompoundDrawablesWithIntrinsicBounds(left, getCompoundDrawables()[1], right,
